...
const MilliyOvqatlar = () => {
  ...
  return (
    <div id="Yevropataomlari" className="mt-10 max-w-full">
      {error ? (
        <div className="text-red-500 text-center">{error}</div>
      ) : (
        <>
          <div className="mb-8">
            <h2 className="text-2xl font-bold mb-4">Yevropa Taomlar</h2>
